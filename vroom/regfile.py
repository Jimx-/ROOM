...
class RegReadDecoder(HasVectorParams, Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.d.comb += uop.opb_sel.eq(VOpB.VS2)
        ...
        with m.Switch(inuop.opcode):
            for opc, alu_op in (
                ...
                (VOpCode.VSADDU, VALUOperator.VSADDU),
                (VOpCode.VSADD, VALUOperator.VSADD),
                (VOpCode.VSSUBU, VALUOperator.VSSUBU),
                (VOpCode.VSSUB, VALUOperator.VSSUB),
                (VOpCode.VAADDU, VALUOperator.VAADDU),
                (VOpCode.VAADD, VALUOperator.VAADD),
                (VOpCode.VASUBU, VALUOperator.VASUBU),
                (VOpCode.VASUB, VALUOperator.VASUB),
                (VOpCode.VSSRL, VALUOperator.VSSR),
                (VOpCode.VSSRA, VALUOperator.VSSRA),
                (VOpCode.VNCLIPU, VALUOperator.VNCLIPU),
                (VOpCode.VNCLIP, VALUOperator.VNCLIP),
            ):
                with m.Case(opc):
