    ...
    def elaborate(self, platform):
        ...
        if self.width >= 64:
            for i in range(self.width // 64):
                ...
                m.d.comb += [
                    ...
                    dcmp.inp.bits.in1.eq(self.inp.bits.in2.word_select(i, 64)),
                    dcmp.inp.bits.in2.eq(self.inp.bits.in1.word_select(i, 64)),
        ...
        for i in range(self.width // 32):
            ...
            m.d.comb += [
                ...
                scmp.inp.bits.in1.eq(self.inp.bits.in2.word_select(i, 32)),
                scmp.inp.bits.in2.eq(self.inp.bits.in1.word_select(i, 32)),
