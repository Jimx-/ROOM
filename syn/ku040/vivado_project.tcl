...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../rtl/JTAGTUNNEL.v"]"\
 "[file normalize "$origin_dir/src/soc_top.v"]"\
 "[file normalize "/tmp/soc_wrapper.v"]"\
 "[file normalize "$origin_dir/constrs/ddr4.xdc"]"\
 "[file normalize "$origin_dir/constrs/fpga.xdc"]"\
  ]
  foreach ifile $files {
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xcku040-ffva1156-2-i -quiet -force
...
set file "[file normalize "$origin_dir/constrs/ddr4.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constrs/ddr4.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constrs/fpga.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constrs/fpga.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set_property -name "top_file" -value "src/soc_top.v" -objects $obj
...
if { [get_files soc_top.v] == "" } {
  import_files -quiet -fileset sources_1 "$origin_dir/src/soc_top.v"
}
...
# soc_top
  ...
  set sdio_clk_0 [ create_bd_port -dir O sdio_clk_0 ]
  set sdio_cmd_0 [ create_bd_port -dir IO sdio_cmd_0 ]
  set sdio_data_0 [ create_bd_port -dir IO -from 3 -to 0 sdio_data_0 ]
  ...
  # Create instance: soc_top_0, and set properties
  set block_name soc_top
  set block_cell_name soc_top_0
  if { [catch {set soc_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net C0_SYS_CLK_0_1 [get_bd_intf_ports c0_sys] [get_bd_intf_pins ddr4_0/C0_SYS_CLK]
  connect_bd_intf_net -intf_net CLK_IN_D_0_1 [get_bd_intf_ports pcie_refclk] [get_bd_intf_pins util_ds_buf_0/CLK_IN_D]
  connect_bd_intf_net -intf_net axi_smc_1_M00_AXI [get_bd_intf_pins axi_smc_1/M00_AXI] [get_bd_intf_pins soc_top_0/saxi]
  ...
  connect_bd_intf_net -intf_net soc_top_0_maxi [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins soc_top_0/maxi]
  connect_bd_intf_net -intf_net xdma_0_M_AXI [get_bd_intf_pins axi_smc_1/S00_AXI] [get_bd_intf_pins xdma_0/M_AXI]
  ...
  connect_bd_intf_net -intf_net xdma_0_axi_periph_M00_AXI [get_bd_intf_pins soc_top_0/saxil] [get_bd_intf_pins xdma_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net xdma_0_pcie_mgt [get_bd_intf_ports pcie_mgt] [get_bd_intf_pins xdma_0/pcie_mgt]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports sdio_cmd_0] [get_bd_pins soc_top_0/sdio_cmd]
  connect_bd_net -net Net1 [get_bd_ports sdio_data_0] [get_bd_pins soc_top_0/sdio_data]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports sys_clk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk1] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins soc_top_0/clk] [get_bd_pins xdma_0_axi_periph/M00_ACLK]
  ...
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports rst_n] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins soc_top_0/aresetn] [get_bd_pins xdma_0_axi_periph/M00_ARESETN]
  ...
  connect_bd_net -net soc_top_0_sdio_ck [get_bd_ports sdio_clk_0] [get_bd_pins soc_top_0/sdio_ck]
  connect_bd_net -net soc_top_0_uart_tx [get_bd_ports uart_tx] [get_bd_pins soc_top_0/uart_tx]
  connect_bd_net -net sys_rst_n_0_1 [get_bd_ports pcie_rst_n] [get_bd_pins xdma_0/sys_rst_n]
  connect_bd_net -net uart_rx_0_1 [get_bd_ports uart_rx] [get_bd_pins soc_top_0/uart_rx]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axi_smc_1/aclk] [get_bd_pins xdma_0/axi_aclk] [get_bd_pins xdma_0_axi_periph/ACLK] [get_bd_pins xdma_0_axi_periph/S00_ACLK]
  ...
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces soc_top_0/maxi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI] [get_bd_addr_segs soc_top_0/saxi/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs soc_top_0/saxil/reg0] -force
